...
public class UdpDocTest {
    static public class Demo extends UntypedActor {
        public void onReceive(Object message) {
            //#manager
            final ActorRef udpFF = Udp.get(system).manager();
            //#manager

            //#simplesend
            udpFF.tell(UdpMessage.simpleSender(), getSelf());
            ...
            //#bind
            udpFF.tell(UdpMessage.bind(handler, new InetSocketAddress("127.0.0.1", 9876)), getSelf());
            //#bind
